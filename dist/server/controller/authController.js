    ...
    AuthController.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4, userRepository.findOneOrFail({ where: { username: username } })];
                case 2:
                    user = _b.sent();
                    return [3, 4];
                case 3:
    ...
    AuthController.changePassword = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4, userRepository.findOneOrFail(id)];
                case 2:
                    user = _b.sent();
                    return [3, 4];
                case 3:
                ...
                case 4:
                    ...
                    if (!user)
                        throw new Error('Der user kann nicht validiert werden!');
                    return [4, class_validator_1.validate(user)];
                case 5:
                    errors = _b.sent();
                    if (errors.length > 0) {
